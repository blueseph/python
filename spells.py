...
spells = {
    #   name                    description                 type    base scaling  cd
    #   0                        1                           2       3     4       5
    'wizard': [
    [       'fireball',  'casts a fireball at an enemy',  'dmg', (20,25), .7,      5],
    [  'magic missile',         'casts a magic missile',  'dmg', (10,15), .3,      0],
    [           'heal',              'heals the player', 'heal',   (6-8), .2,     20],
    ]
    }
...
def castSpell(caster, defender, spellChoice):
    ...
    spellCooldown   = spells[caster.unitclass][spellChoice][5]
